...
def main(args, index, hyperparams, comb):
    ...
    result.to_csv(f"{args.datadir}/performance/performance_prf/{args.collection}_{args.model_name}_{filter_name}_{measure_name}_{comb}.csv", index=False)
...
if __name__ == "__main__":
    ...
    import pickle
    hyperparams_filename = f"data/performance/performance_prf/hyperparams.pickle"
